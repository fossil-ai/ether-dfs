...
public class CommandParser {
	 ...
	 * - ls 1, {show files in current working directory}
	 * - cd [directory] 2, {navigate to directory}
	 * - cat [filename], 2, {read a file}
	 * - nano [filename] 2, {for both creating and writing/editing a file}
	 * - pwd  1, {show the current working directory}
	 * - mkdir [dirname], 2 {create directory}
	...
	enum Command {
	    ...
	    public int argsNum(){ return argsNum; }
